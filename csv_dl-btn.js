  ...
  var namesToCheckForBaihen  = ["商品番号", "システム連携用SKU番号", "在庫数", "販売価格", "表示価格", "二重価格文言管理番号", "送料", "送料区分1", "配送方法セット管理番号", "ポイント変倍率", "ポイント変倍率適用期間", "販売期間指定日時", "キャッチコピー", "商品名", "倉庫指定", "サーチ表示", "カタログID", "カタログIDなしの理由"];
